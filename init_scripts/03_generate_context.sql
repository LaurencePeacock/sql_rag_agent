...
INSERT INTO context(
    ...
    ('bank_client', 'pr_coverage_tracker', 'domain_authority', 'INTEGER', CURRENT_TIMESTAMP, TRUE),
    ('bank_client', 'pr_coverage_tracker', 'estimated_views', 'INTEGER', CURRENT_TIMESTAMP, TRUE),
    ('bank_client', 'pr_coverage_tracker', 'tier', 'VARCHAR(50)', CURRENT_TIMESTAMP, TRUE),
    ('bank_client', 'pr_coverage_tracker', 'syndicated', 'BOOLEAN', CURRENT_TIMESTAMP, TRUE),
    ('bank_client', 'pr_coverage_tracker', 'brand', 'VARCHAR(255)', CURRENT_TIMESTAMP, TRUE),
    ('bank_client', 'pr_coverage_tracker', 'month', 'INTEGER', CURRENT_TIMESTAMP, TRUE),
    ('bank_client', 'pr_coverage_tracker', 'week', 'INTEGER', CURRENT_TIMESTAMP, TRUE);
